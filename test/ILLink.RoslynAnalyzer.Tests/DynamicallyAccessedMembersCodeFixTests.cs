...
using Xunit;
//using static ILLink.RoslynAnalyzer.Tests.CSharpCodeFixVerifier<TAnalyzer, TCodeFix>;
...
build_property.{MSBuildPropertyOptionNames.EnableTrimAnalyzer} = true")));
		...
		public async Task CodeFix_IL2072_MismatchMethodReturnTargetsParam ()
		{
			...
			await VerifyDynamicallyAccessedMembersCodeFix (test, fixtest, new[] {
				// /0/Test0.cs(12,3): warning IL2072: 'type' argument does not satisfy 'DynamicallyAccessedMemberTypes.PublicMethods' in call to 'C.NeedsPublicMethodsOnParameter(Type)'.
		...
		public async Task CodeFix_IL2074_MismatchMethodReturnTargetsField ()
		{
			...
			""";
			await VerifyDynamicallyAccessedMembersCodeFix (test, fixtest, new[] {
				// /0/Test0.cs(12,3): warning IL2074: value stored in field 'C.f' does not satisfy 'DynamicallyAccessedMemberTypes.PublicMethods' requirements.
		...
		public async Task CodeFix_IL2077_MismatchFieldTargetsParam ()
		{
			...
			""";
			await VerifyDynamicallyAccessedMembersCodeFix (test, fixtest, new[] {
			  // /0/Test0.cs(14,3): warning IL2077: 'type' argument does not satisfy 'DynamicallyAccessedMemberTypes.PublicMethods' in call to 'C.NeedsPublicMethods(Type)'.
		...
		public async Task CodeFix_IL2079_MismatchFieldTargetsField ()
		{
			...
			""";
			await VerifyDynamicallyAccessedMembersCodeFix (test, fixtest, new[] {
			  // /0/Test0.cs(17,3): warning IL2079: value stored in field 'C.f2' does not satisfy 'DynamicallyAccessedMemberTypes.PublicMethods' requirements.
