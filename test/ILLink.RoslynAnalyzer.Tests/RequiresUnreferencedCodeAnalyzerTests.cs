...
class BaseClass
{
	...
	public virtual string VirtualProperty { get; set; }
			...
			return VerifyRequiresUnreferencedCodeAnalyzer (src,
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (7, 23, 7, 36).WithArguments ("Member 'DerivedClass.VirtualMethod()' with 'RequiresUnreferencedCodeAttribute' overrides base member 'BaseClass.VirtualMethod()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (15, 3, 15, 6).WithArguments ("Member 'DerivedClass.VirtualProperty.get' with 'RequiresUnreferencedCodeAttribute' overrides base member 'BaseClass.VirtualProperty.get' without 'RequiresUnreferencedCodeAttribute'"));
		}
...
class BaseClass
{
	...
	public virtual string VirtualProperty {[RequiresUnreferencedCode(""Message"")] get; set; }
			...
			return VerifyRequiresUnreferencedCodeAnalyzer (src,
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (13, 3, 13, 6).WithArguments ("Base member 'BaseClass.VirtualProperty.get' with 'RequiresUnreferencedCodeAttribute' has a derived member 'DerivedClass.VirtualProperty.get' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (6, 23, 6, 36).WithArguments ("Base member 'BaseClass.VirtualMethod()' with 'RequiresUnreferencedCodeAttribute' has a derived member 'DerivedClass.VirtualMethod()' without 'RequiresUnreferencedCodeAttribute'"));
		}
...
interface IRUC
{
	...
	string Property { get; set; }
			...
			return VerifyRequiresUnreferencedCodeAnalyzer (src,
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (7, 14, 7, 17).WithArguments ("Member 'Implementation.RUC()' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRUC.RUC()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (13, 3, 13, 6).WithArguments ("Member 'Implementation.Property.get' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRUC.Property.get' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (33, 12, 33, 15).WithArguments ("Member 'ExplicitImplementation.IRUC.RUC()' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRUC.RUC()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (39, 3, 39, 6).WithArguments ("Member 'ExplicitImplementation.IRUC.Property.get' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRUC.Property.get' without 'RequiresUnreferencedCodeAttribute'"));
		}
...
interface IRUC
{
	...
	string Property {[RequiresUnreferencedCode(""Message"")] get; set; }
			...
			return VerifyRequiresUnreferencedCodeAnalyzer (src,
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (6, 14, 6, 17).WithArguments ("Interface member 'IRUC.RUC()' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'Implementation.RUC()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (11, 3, 11, 6).WithArguments ("Interface member 'IRUC.Property.get' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'Implementation.Property.get' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (18, 14, 18, 17).WithArguments ("Interface member 'IRUC.RUC()' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'AnotherImplementation.RUC()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (23, 3, 23, 6).WithArguments ("Interface member 'IRUC.Property.get' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'AnotherImplementation.Property.get' without 'RequiresUnreferencedCodeAttribute'"));
		}
...
";
			...
			await VerifyRequiresUnreferencedCodeAnalyzer (src, additionalReferences: new[] { compilation },
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (4, 14, 4, 20).WithArguments ("Interface member 'IRAF.Method()' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'Implementation.Method()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (16, 14, 16, 20).WithArguments ("Interface member 'IRAF.Method()' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'AnotherImplementation.Method()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (9, 3, 9, 6).WithArguments ("Interface member 'IRAF.StringProperty.get' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'Implementation.StringProperty.get' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (21, 3, 21, 6).WithArguments ("Interface member 'IRAF.StringProperty.get' with 'RequiresUnreferencedCodeAttribute' has an implementation member 'AnotherImplementation.StringProperty.get' without 'RequiresUnreferencedCodeAttribute'"));
		}
...
";
			...
			await VerifyRequiresUnreferencedCodeAnalyzer (src, additionalReferences: new[] { compilation },
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (7, 14, 7, 20).WithArguments ("Member 'Implementation.Method()' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRAF.Method()' without 'RequiresUnreferencedCodeAttribute'"),
				...
				VerifyCS.Diagnostic (DiagnosticId.RequiresAttributeMismatch).WithSpan (13, 3, 13, 6).WithArguments ("Member 'Implementation.StringProperty.get' with 'RequiresUnreferencedCodeAttribute' implements interface member 'IRAF.StringProperty.get' without 'RequiresUnreferencedCodeAttribute'"));
		}
	}
}
