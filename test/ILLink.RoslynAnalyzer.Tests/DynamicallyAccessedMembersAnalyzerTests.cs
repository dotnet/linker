...
class C
{
    ...
    private static void M([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] Type type)
    {
		...
		[Fact]
		public Task UnsupportedReflectionOfFieldWithDynamicallyAccessedMembers ()
		{
			var source = @"
using System;
using System.Diagnostics.CodeAnalysis;
...
";
		...
		[Fact]
		public Task UnsupportedReflectionOfMethodWithDynamicallyAccessedMembers ()
		{
			var source = @"
using System;
using System.Diagnostics.CodeAnalysis;
class AnnotatedField
{
    public static void MethodWithDynamicallyAccessedMembersInParameter ([DynamicallyAccessedMembers (DynamicallyAccessedMemberTypes.PublicFields)] int parameter) { }

    static void DynamicallyAccessedMembers ()
    {
        typeof (AnnotatedField).RequiresPublicMethods ();
    }
