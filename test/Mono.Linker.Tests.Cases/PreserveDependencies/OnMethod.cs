...
namespace Mono.Linker.Tests.Cases.PreserveDependencies
{
	...
	[LogContains ("Could not resolve dependency member '' declared in type 'Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod.B'")]
	[LogContains ("Could not resolve dependency member '.ctor' declared in type 'Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod.NestedStruct'")]
	...
	class OnMethod
	{
		...
		class B
		{
			...
			[PreserveDependency ("NextOne (Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod+Nested&)", "Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod+Nested")]
			[PreserveDependency (".cctor()", "Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod+Nested")]
			...
			[PreserveDependency ("")]
			[PreserveDependency (".ctor()", "Mono.Linker.Tests.Cases.PreserveDependencies.OnMethod+NestedStruct")]
