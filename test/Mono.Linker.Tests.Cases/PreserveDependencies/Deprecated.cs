...
namespace Mono.Linker.Tests.Cases.PreserveDependencies
{
	...
	class Deprecated
	{
		...
		class B
		{
			...
			[PreserveDependency ("NextOne (Mono.Linker.Tests.Cases.PreserveDependencies.Deprecated+Nested&)", "Mono.Linker.Tests.Cases.PreserveDependencies.Deprecated+Nested")]
			[PreserveDependency (".cctor()", "Mono.Linker.Tests.Cases.PreserveDependencies.Deprecated+Nested")]
			...
			[PreserveDependency ("")]
			[PreserveDependency (".ctor()", "Mono.Linker.Tests.Cases.PreserveDependencies.Deprecated+NestedStruct")]
