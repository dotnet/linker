...
namespace Mono.Linker.Tests.Cases.DynamicDependencies
{
	class OnMethod
	{
		...
		class B
		{
			...
			[DynamicDependency ("NextOne(Mono.Linker.Tests.Cases.DynamicDependencies.OnMethod.Nested@)", typeof (Nested))]
			...
			[DynamicDependency ("M``1(Mono.Linker.Tests.Cases.DynamicDependencies.OnMethod.Complex.S{" +
				"Mono.Linker.Tests.Cases.DynamicDependencies.OnMethod.Complex.G{" +
					"Mono.Linker.Tests.Cases.DynamicDependencies.OnMethod.Complex.A,``0}}" +
