...
namespace Mono.Linker.Tests.Cases.DynamicDependencies
{
	...
	[SetupCompileBefore ("reference.dll", new[] { "Dependencies/MethodInNonReferencedAssemblyChainedLibrary.cs" }, references: new[] { "base.dll" }, addAsReference: false)]
	...
	[KeptMemberInAssembly ("library.dll", "Mono.Linker.Tests.Cases.DynamicDependencies.Dependencies.MethodInNonReferencedAssemblyChainedReferenceLibrary", "Method()")]
	[KeptMemberInAssembly ("reference.dll", "Mono.Linker.Tests.Cases.DynamicDependencies.Dependencies.MethodInNonReferencedAssemblyChainedLibrary", "Method()")]
	public class MethodInNonReferencedAssemblyChainedReference
	{
		...
		[Kept]
		[DynamicDependency ("#ctor()", "Mono.Linker.Tests.Cases.DynamicDependencies.Dependencies.MethodInNonReferencedAssemblyChainedReferenceLibrary", "library")]
