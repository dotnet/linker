...
namespace Log
{
	public class LogStep : IStep
	{
		...
		{
			var msgError = MessageContainer.CreateErrorMessage ("Error", 6001);
			var msgWarning = MessageContainer.CreateWarningMessage (context, "Warning", 6002, origin: new MessageOrigin ("logtest", 1, 1), version: WarnVersion.Latest);
