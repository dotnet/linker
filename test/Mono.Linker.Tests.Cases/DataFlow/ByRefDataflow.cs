...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class ByRefDataflow
	{
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (ByRefDataflow), nameof (MethodWithRefParameter), new string[] { "ref Type" }, messageCode: "IL2077")]
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (ByRefDataflow), nameof (MethodWithRefParameter), new string[] { "ref Type" }, messageCode: "IL2067")]
