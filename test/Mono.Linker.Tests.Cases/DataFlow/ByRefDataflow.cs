...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	...
	class ByRefDataflow
	{
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (ByRefDataflow), nameof (MethodWithRefParameter), new string[] { "System.Type&" }, messageCode: "IL2074")]
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (ByRefDataflow), nameof (MethodWithRefParameter), new string[] { "System.Type&" }, messageCode: "IL2006")]
