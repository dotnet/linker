...
namespace Mono.Linker.Tests.Cases.DataFlow
{
	public class DynamicDependencyDataflow
	{
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (Type), "GetField", new Type[] { typeof (string) }, messageCode: "IL2077")]
		...
		[Kept]
		[UnrecognizedReflectionAccessPattern (typeof (Type), "GetProperty", new Type[] { typeof (string) }, messageCode: "IL2077")]
