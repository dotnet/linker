...
{
	[SetupCompileBefore ("library.dll", new[] { typeof (DebuggerDisplayOnAssemblyTargetTypeNameInAssembly_Lib) })]
	...
	[RemovedMemberInAssembly ("library.dll", typeof (DebuggerDisplayOnAssemblyTargetTypeNameInAssembly_Lib), "get_Property()")]
	[KeptMemberInAssembly ("library.dll", typeof (DebuggerDisplayOnAssemblyTargetTypeNameInAssembly_Lib), "set_Property(System.Int32)")]
	public class DebuggerDisplayOnAssemblyUsingTargetTypeNameInAssembly
	{
