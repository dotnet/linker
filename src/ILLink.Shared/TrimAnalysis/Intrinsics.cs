...
namespace ILLink.Shared.TrimAnalysis
{
	class Intrinsics
	{
		...
		public static bool HandleMethodCall (MethodProxy calledMethod, MultiValue instanceValue, IReadOnlyList<MultiValue> argumentValues, out MultiValue methodReturnValue)
		{
