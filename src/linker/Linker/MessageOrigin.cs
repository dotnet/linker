...
#nullable disable
		...
		public int CompareTo (MessageOrigin other)
		{
			if (MemberDefinition != null && other.MemberDefinition != null) {
				return (MemberDefinition.DeclaringType.Module.Assembly.Name, MemberDefinition.DeclaringType.Name, MemberDefinition.Name).CompareTo
					((other.MemberDefinition.DeclaringType.Module.Assembly.Name, other.MemberDefinition.DeclaringType.Name, MemberDefinition.Name));
