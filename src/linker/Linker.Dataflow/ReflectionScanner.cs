...
namespace Mono.Linker.Dataflow
{
	sealed class ReflectionScanner : Scanner
	{
		...
		public ReflectionScanner (LinkContext context, MethodDefinition method, MarkStep parent, MessageOrigin origin, TrimAnalysisPatternStore trimAnalysisPatternStore)
			: base (context)
		{
			_markStep = parent;
			_origin = origin;
			...
			TrimAnalysisPatterns = trimAnalysisPatternStore;
			_method = method;
		}
