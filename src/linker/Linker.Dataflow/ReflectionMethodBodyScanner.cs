		...
		void RequireDynamicallyAccessedMembers (ref ReflectionPatternContext reflectionContext, DynamicallyAccessedMemberTypes requiredMemberTypes, ValueNode value, IMetadataTokenProvider targetContext)
		{
			...
			static DiagnosticId GetDiagnosticId (IMetadataTokenProvider source, IMetadataTokenProvider target)
				=> (source, target) switch {
					...
					(ParameterDefinition, MethodDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchParameterTargetsMethod,
					...
					(MethodReturnType, MethodDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodReturnTypeTargetsMethod,
					...
					(FieldDefinition, MethodDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchFieldTargetsMethod,
					(FieldDefinition, GenericParameter) => DiagnosticId.DynamicallyAccessedMembersMismatchFieldTargetsGenericParameter,
					(MethodDefinition, ParameterDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodTargetsParameter,
					(MethodDefinition, MethodReturnType) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodTargetsMethodReturnType,
					(MethodDefinition, FieldDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodTargetsField,
					(MethodDefinition, MethodDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodTargetsMethod,
					(MethodDefinition, GenericParameter) => DiagnosticId.DynamicallyAccessedMembersMismatchMethodTargetsGenericParameter,
					...
					(GenericParameter, MethodDefinition) => DiagnosticId.DynamicallyAccessedMembersMismatchTypeArgumentTargetsMethod,
