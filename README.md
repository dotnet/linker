...
The [IL Linker](src/linker/README.md) is the developer's tool than can be used to produce apps that contain only code and assembly dependencies which are necessary to run the app. It's fully integrated into
